...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Gestion\\ContactBundle\\Resources\\config\\doctrine') => 'Gestion\\ContactBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Esprit\\UserBundle\\Entity'))), 'Esprit\\UserBundle\\Entity');
        $b->addDriver($a, 'Gestion\\ContactBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('UserBundle' => 'Esprit\\UserBundle\\Entity', 'ContactBundle' => 'Gestion\\ContactBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0f23be2432b289c80016d702eaf1d2f1e7e5ad39dfbe470ffbd39e8b7073d658');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Esprit\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Esprit\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Esprit\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Esprit\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Esprit\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Esprit\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Gestion\\ContactBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'\\src\\Gestion\\ContactBundle/Resources/views'), 'Contact');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'Esprit\\UserBundle\\UserBundle',
                'ContactBundle' => 'Gestion\\ContactBundle\\ContactBundle',
            ...
            'fos_user.model.user.class' => 'Esprit\\UserBundle\\Entity\\Utilisateur',
